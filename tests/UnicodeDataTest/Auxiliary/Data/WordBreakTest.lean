...
namespace UnicodeDataTest.Auxiliary.Data.WordBreakTest

public def path : String := "../table-generators/data-ucd/auxiliary/WordBreakTest.txt"
...
end UnicodeDataTest.Auxiliary.Data.WordBreakTest
