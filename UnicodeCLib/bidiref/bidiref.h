 ...
 * 2021-Sep-23 kenw   Add UBA140.
 * 2022-Sep-29 kenw   Add UBA150.
 * 2023-Oct-03 kenw   Add UBA151.
 * 2024-Sep-25 kenw   Add UBA160.
 */
 ...
 *
 * MAINTENANCE NOTE: For each new Unicode version for which
 * a UBA implementation is to be added for this bidiref code,
 * add a single enum value just before UBACUR in the enum
 * listing below. Specify the rule set and repertoire in
 * the comment.
 */
...
typedef enum 
    ...
    UBA151, /* UBA 8.0.0 rule set; Unicode 15.1.0 repertoire */
    UBA160, /* UBA 8.0.0 rule set; Unicode 16.0.0 repertoire */
