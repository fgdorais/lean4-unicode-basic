 ...
 * 2021-Sep-23 kenw   Update NUMVERSIONS for UBA140.
 *                    Updated CJK range constants for Unicode 14.0.
 * 2022-Sep-30 kenw   Update NUMVERSIONS for UBA150.
 *                    Updated CJK range constants for Unicode 15.0.
 * 2023-Oct-03 kenw   Updated NUMVERSIONS for UBA151.
 *                    Updated CJK range constants for Unicode 15.1.
 * 2024-Sep-25 kenw   Updated NUMVERSIONS for UBA160.
 */
 ...
 *
 * MAINTENANCE NOTE: This number needs to be bumped up by one,
 * each time a new UBA version is added to this code.
 */

#define NUMVERSIONS (15)

/*
 * Constants defining Unihan ranges. These ranges define the
 * actual ranges of encoded unified ideographs inside each
 * block, and not the full ranges of the blocks themselves.
 *
 * MAINTENANCE NOTE: These constants need to be updated each time
 * a new version of Unicode either extends the range of an existing
 * CJK block or adds a new CJK block (or both).
 */
