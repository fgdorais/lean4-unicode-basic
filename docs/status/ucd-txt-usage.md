...
| `data/ucd/auxiliary/GraphemeBreakTest.txt` | used by tests | tests/UnicodeDataTest/Auxiliary/Data/GraphemeBreakTest.lean:11 [direct], tests/UnicodeDataTest/Auxiliary/Test.lean:53 [direct] (2 matches) |
| `data/ucd/auxiliary/LineBreakTest.txt` | used by tests | tests/UnicodeDataTest/Auxiliary/Data/LineBreakTest.lean:11 [direct], tests/UnicodeDataTest/Auxiliary/Test.lean:74 [direct] (2 matches) |
...
| `data/ucd/auxiliary/SentenceBreakTest.txt` | used by tests | tests/UnicodeDataTest/Auxiliary/Data/SentenceBreakTest.lean:11 [direct], tests/UnicodeDataTest/Auxiliary/Test.lean:67 [direct] (2 matches) |
| `data/ucd/auxiliary/WordBreakProperty.txt` | used by Lean library | UnicodeBasic.lean:942 [direct], UnicodeData/Auxiliary/BreakProperties.lean:21 [direct], UnicodeData/Auxiliary/BreakProperties.lean:22 [direct], UnicodeData/Auxiliary/BreakProperties.lean:40 [direct], ... (5 matches) |
| `data/ucd/auxiliary/WordBreakTest.txt` | used by tests | tests/UnicodeDataTest/Auxiliary/Data/WordBreakTest.lean:11 [direct], tests/UnicodeDataTest/Auxiliary/Test.lean:60 [direct] (2 matches) |

## conformance

| File | Usage | Places |
| --- | --- | --- |
| `data/ucd/conformance/BidiCharacterTest.txt` | used by tests | tests/UnicodeDataTest/Common/Types.lean:35 [direct], tests/UnicodeDataTest/Conformance/Bidi.lean:116 [direct], tests/UnicodeDataTest/Conformance/Data/BidiCharacterTest.lean:34 [direct], tests/UnicodeDataTest/Conformance/Test.lean:30 [direct] (4 matches) |
| `data/ucd/conformance/BidiTest.txt` | used by tests | tests/UnicodeDataTest/Common/Types.lean:46 [direct], tests/UnicodeDataTest/Conformance/Bidi.lean:146 [direct], tests/UnicodeDataTest/Conformance/Data/BidiTest.lean:43 [direct], tests/UnicodeDataTest/Conformance/Test.lean:39 [direct] (4 matches) |
| `data/ucd/conformance/NormalizationTest.txt` | used by tests | tests/UnicodeDataTest/Conformance/Data/NormalizationTest.lean:34 [direct], tests/UnicodeDataTest/Conformance/Test.lean:21 [direct] (2 matches) |
...
| `data/ucd/core/BidiBrackets.txt` | used by Lean library | UnicodeBasic/Bidi.lean:707 [direct], UnicodeBasic/TableLookup.lean:105 [direct], UnicodeData/Core/BidiBrackets.lean:13 [direct], UnicodeData/Core/BidiBrackets.lean:19 [direct], ... (5 matches) |
| `data/ucd/core/BidiMirroring.txt` | used by Lean library | UnicodeData/Core/BidiMirroring.lean:14 [direct], UnicodeData/Core/BidiMirroring.lean:15 [direct], UnicodeData/Core/BidiMirroring.lean:17 [direct] (3 matches) |
| `data/ucd/core/Blocks.txt` | used by Lean library | UnicodeData/Core/Blocks.lean:13 [direct], UnicodeData/Core/Blocks.lean:14 [direct], UnicodeData/Core/Blocks.lean:33 [direct] (3 matches) |
...
| `data/ucd/core/EastAsianWidth.txt` | used by Lean library | UnicodeData/Extracted/DerivedEastAsianWidth.lean:13 [direct], UnicodeData/Extracted/DerivedEastAsianWidth.lean:14 [direct], UnicodeData/Extracted/DerivedEastAsianWidth.lean:16 [direct] (3 matches) |
...
| `data/ucd/core/PropList.txt` | used by Lean library | UnicodeBasic.lean:524 [direct], UnicodeBasic.lean:1165 [direct], UnicodeData/Core/PropList.lean:11 [direct], UnicodeData/Core/PropList.lean:58 [direct], ... (23 matches) |
...
| `data/ucd/core/VerticalOrientation.txt` | used by Lean library | UnicodeData/Core/VerticalOrientation.lean:13 [direct], UnicodeData/Core/VerticalOrientation.lean:14 [direct], UnicodeData/Core/VerticalOrientation.lean:16 [direct], UnicodeData/Core/VerticalOrientation.lean:25 [direct] (4 matches) |
...
| `data/ucd/extracted/DerivedEastAsianWidth.txt` | used by Lean library | UnicodeData/Extracted/DerivedEastAsianWidth.lean:13 [direct], UnicodeData/Extracted/DerivedEastAsianWidth.lean:14 [direct] (2 matches) |
